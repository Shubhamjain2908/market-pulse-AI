...
CREATE TABLE concall_transcripts (
  symbol        TEXT NOT NULL,
...
CREATE INDEX idx_concall_intel_symbol ON concall_intel(symbol);
CREATE INDEX idx_concall_intel_announced_at ON concall_intel(announced_at);
