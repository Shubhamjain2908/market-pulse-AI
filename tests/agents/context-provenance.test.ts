...
import { upsertQuotes, upsertSignals, upsertFundamentals, insertNews } from '../../src/db/queries.js';
...
describe('buildContextProvenance', () => {
  ...
  it('captures quote range', () => {
    upsertQuotes(
      [
        { symbol: 'RELIANCE', exchange: 'NSE', date: '2026-06-15', open: 100, high: 105, low: 99, close: 104, volume: 1000, source: 'nse' },
        { symbol: 'RELIANCE', exchange: 'NSE', date: '2026-06-16', open: 104, high: 108, low: 103, close: 107, volume: 1200, source: 'nse' },
        { symbol: 'RELIANCE', exchange: 'NSE', date: '2026-06-17', open: 107, high: 110, low: 106, close: 109, volume: 900, source: 'nse' },
      ],
      db,
    );
  ...
  it('captures news headlines', () => {
    insertNews(
      [
        { headline: 'RIL Q1 results beat estimates', source: 'Moneycontrol', url: 'https://example.com/ril', publishedAt: '2026-06-30T10:00:00Z' },
      ],
      db,
    );
    const refs = buildContextProvenance('RELIANCE', '2026-07-04', db);
  ...
  it('ignores news outside the 7-day window', () => {
    insertNews(
      [
        { headline: 'Old RIL news', source: 'Moneycontrol', url: 'https://example.com/old', publishedAt: '2026-06-01T10:00:00Z' },
      ],
      db,
    );
    const refs = buildContextProvenance('RELIANCE', '2026-07-04', db);
  ...
  it('upper-cases symbol for DB lookups', () => {
    upsertQuotes(
      [
        { symbol: 'TCS', exchange: 'NSE', date: '2026-06-20', open: 100, high: 105, low: 99, close: 104, volume: 1000, source: 'nse' },
      ],
      db,
    );
