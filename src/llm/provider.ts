...
export const MODEL_COST_USD_PER_TOKEN: Record<string, { input: number; output: number }> = {
  // DeepSeek Tier — off-peak rates (peak = 2x on weekdays 06:30-09:30 & 11:30-15:30 IST)
  // https://api-docs.deepseek.com/quick_start/pricing/ (Aug 2026)
  'deepseek-chat': { input: perMillion(0.22), output: perMillion(0.66) },
  'deepseek-v4-flash': { input: perMillion(0.22), output: perMillion(0.66) },
  'deepseek-v4-pro': { input: perMillion(0.66), output: perMillion(1.98) },
