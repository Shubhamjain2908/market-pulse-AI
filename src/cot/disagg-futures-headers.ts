/**
 * Canonical column names for CFTC disaggregated futures-only file (f_disagg.txt).
 * Source: CFTC Historical Viewable CFTC_023168 (191 fields). Live file has no header row.
 */
export const DISAGG_FUTURES_ONLY_COLUMN_NAMES = [
...
export const DISAGG_FUTURES_ONLY_COLUMN_COUNT = DISAGG_FUTURES_ONLY_COLUMN_NAMES.length;
