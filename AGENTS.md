...
## Scheduler and Tests
- Scheduler in `src/scheduler/market-scheduler.ts` (Asia/Kolkata): weekdays 08:45/16:30, Saturday 08:00, Sunday 06:00 earnings refresh, Sunday 07:30 weekly DB cleanup (`runWeeklyCleanup`: briefings 90d, signals 730d), Sunday 07:45 COMEX gold COT (`pnpm cot:gold`), Sunday 08:00 momentum rebalance + skip-AI briefing delivery.
